...
param (
 ...
 [ValidateNotNullOrEmpty()]$VersionList
	...
	'mscpp2019x64' = [PSCustomObject]@{Name = 'mscpp2019x64'; Configuration = 'x64'; SilentInstallArgs = '/quiet /norestart'; Version = '14.21.27702'; Description = 'Microsoft Visual C++ 2015-2019 Redistributable (x64)'; RegPath = 'HKLM:\SOFTWARE\Classes\Installer\Dependencies\VC,redist.x64,amd64,14.21,bundle\Dependents\'; RegValue = '{f4220b74-9edd-4ded-bc8b-0342c1e164d8}'; DownloadUrl = 'https://download.visualstudio.microsoft.com/download/pr/9e04d214-5a9d-4515-9960-3d71398d98c3/1e1e62ab57bbb4bf5199e8ce88f040be/vc_redist.x64.exe'}
	'mscpp2019x86' = [PSCustomObject]@{Name = 'mscpp2019x86'; Configuration = 'x86'; SilentInstallArgs = '/quiet /norestart'; Version = '14.21.27702'; Description = 'Microsoft Visual C++ 2015-2019 Redistributable (x86)'; RegPath = 'HKLM:\SOFTWARE\Classes\Installer\Dependencies\VC,redist.x64,x86,14.21,bundle\Dependents\'; RegValue = '{49697869-be8e-427d-81a0-c334d1d14950}'; DownloadUrl = 'https://download.visualstudio.microsoft.com/download/pr/c8edbb87-c7ec-4500-a461-71e8912d25e9/99ba493d660597490cbb8b3211d2cae4/vc_redist.x86.exe'}
	}
