...
param (
 ...
 [ValidateNotNullOrEmpty()]$VersionList
	...
	'mscpp2019x64' = [PSCustomObject]@{Name = 'mscpp2019x64'; Configuration = 'x64'; SilentInstallArgs = '/quiet /norestart'; Version = '14.22.27821'; Description = 'Microsoft Visual C++ 2015-2019 Redistributable (x64)'; RegPath = 'HKLM:\SOFTWARE\Classes\Installer\Dependencies\VC,redist.x64,amd64,14.22,bundle\Dependents\'; RegValue = '{6361b579-2795-4886-b2a8-53d5239b6452}'; DownloadUrl = 'https://download.visualstudio.microsoft.com/download/pr/cc0046d4-e7b4-45a1-bd46-b1c079191224/9c4042a4c2e6d1f661f4c58cf4d129e9/vc_redist.x64.exe'}
	'mscpp2019x86' = [PSCustomObject]@{Name = 'mscpp2019x86'; Configuration = 'x86'; SilentInstallArgs = '/quiet /norestart'; Version = '14.22.27821'; Description = 'Microsoft Visual C++ 2015-2019 Redistributable (x86)'; RegPath = 'HKLM:\SOFTWARE\Classes\Installer\Dependencies\VC,redist.x64,x86,14.22,bundle\Dependents\'; RegValue = '{5bfc1380-fd35-4b85-9715-7351535d077e}'; DownloadUrl = 'https://download.visualstudio.microsoft.com/download/pr/0c1cfec3-e028-4996-8bb7-0c751ba41e32/1abed1573f36075bfdfc538a2af00d37/vc_redist.x86.exe'}
	}
