...
param (
 ...
 [ValidateNotNullOrEmpty()]$VersionList
	...
	'mscpp2019x64' = [PSCustomObject]@{Name = 'mscpp2019x64'; Configuration = 'x64'; SilentInstallArgs = '/quiet /norestart'; Version = '14.29.30135'; Description = 'Microsoft Visual C++ 2015-2019 Redistributable (x64)'; RegPath = 'HKLM:\SOFTWARE\Classes\Installer\Dependencies\VC,redist.x64,amd64,14.29,bundle\Dependents\'; RegValue = '{fa7f6d52-f85e-48ef-8f56-a37268aa5772}'; DownloadUrl = 'https://aka.ms/vs/16/release/vc_redist.x64.exe'}
	'mscpp2019x86' = [PSCustomObject]@{Name = 'mscpp2019x86'; Configuration = 'x86'; SilentInstallArgs = '/quiet /norestart'; Version = '14.29.30135'; Description = 'Microsoft Visual C++ 2015-2019 Redistributable (x86)'; RegPath = 'HKLM:\SOFTWARE\Classes\Installer\Dependencies\VC,redist.x64,x86,14.29,bundle\Dependents\'; RegValue = '{b7a2b241-3f54-4d7d-94d1-8ce0146e03c7}'; DownloadUrl = 'https://aka.ms/vs/16/release/vc_redist.x86.exe'}
